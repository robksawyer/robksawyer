...
const HamburgerMenu = (props) => {
  const {
    tagName: Tag = "div",
    className = "absolute z-10 transform scale-75 top-14 right-12",
    variant = "default",
    children = "",
  } = props;
  ...
  return (
    ...
    >
      <div
        ...
        aria-pressed="false"
        tabIndex="0"
        className="hamburger-menu outer-container flex justify-center align-center items-center focus:outline-none focus:shadow-none"
